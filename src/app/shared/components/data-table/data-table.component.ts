...
export class DataTableComponent implements OnInit {
  ...
  public viewDetails(resourceId: number) {
    this.route.navigateByUrl(`/upload/image-profile?resourceId=${resourceId}`);
  }

  public navigateToMessage(resourceId: number) {
    this.route.navigateByUrl(`/upload/image-review?resourceId=${resourceId}`);
  }
